  ...
  group('Cache', () {
    ...
    group('remove', () {
      ...
      test('should not call onDidRemove when identifier is not cached',
        ...
        verifyNever(stubCachingStrategy.onDidRemove('', {}));
      });
      ...
      test('should not call onWillRemove when identifier is not cached',
        ...
        verifyNever(stubCachingStrategy.onWillRemove(''));
      });
    ...
    group('release', () {
      ...
      test('should not call onWillRemove when identifer is not cached',
        ...
        var childCache = Cache(stubCachingStrategy);
        await childCache.release(cachedId);
        verifyNever(stubCachingStrategy.onWillRelease(''));
      });
...
class MockCachingStrategy extends Mock
  ...
  MockCachingStrategy() {
    when(onDidGet('', {})).thenAnswer((i) => Future.value(null));
    when(onDidRelease('', {}, (_) => Future<Null>.value(null)))
        .thenAnswer((i) => Future.value(null));
    when(onDidRemove('', {})).thenAnswer((i) => Future.value(null));
  }
}
